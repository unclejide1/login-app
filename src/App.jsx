    ...
    >
      ...
      >
        ...
        ></path>
          ...
          <div className="forgot-link"><span ><svg className="pad" width="12px" height="12px" aria-hidden="true" role="img" focusable="false"><path d="M5.79535 10.4696C5.98566 10.6697 6.30215 10.6776 6.50224 10.4873L10.828 6.37298C11.0448 6.17982 11.0524 5.84013 10.8396 5.63769L6.50222 1.51269C6.30213 1.32239 5.98564 1.33033 5.79534 1.53043C5.60504 1.73053 5.61298 2.04701 5.81308 2.23731L9.24373 5.5H1.45C1.20147 5.5 1 5.72386 1 6C1 6.27614 1.20147 6.5 1.45 6.5H9.24346L5.81306 9.7627C5.61297 9.95301 5.60504 10.2695 5.79535 10.4696Z"></path></svg><span className="WFLink__text___Ia8fg"><span data-localized="loginApp.login.label.forgotUsernamePassword">Forgot username or password?</span></span></span></div>
          {/* <a href="#" className="forgot-link">Forgot username or password?</a> */}
        </form>
      </div>
